...
function Quiz({ currentUser }) {
  ...
  const questions = [
    {
      question:
        "Back in 2000, the stock of global debt was 83 Trillion. What was that amount as of the end of 2021?",
      answers: [
    ...
    {
      question:
        "On February 2nd, the stocks of this big tech company went crashing down 26% and was the 'biggest one-day dollar drop in market history', which company was this?",
      difficulty: "easy",
      answers: [
    ...
    {
      question:
        "Great Work! You have completed the quiz. See your answer by clicking below.",
      answers: [{ answerText: "See Results", isCorrect: true, difficulty: "" }],
    },
  ];
  ...
  function handleAnswer(isCorrect) {
    ...
    if (nextQuestion < questions.length) {
      ...
      if (quizStatus === false) {
        ...
        alert(
          "You have already taken the quiz today and cannot receive further cash until tomorrow!"
        );
      }
    }
  }
  ...
  return (
    <section className="quizSection">
      ...
      {quizStatus ? (
        <h3 className="quizAlert"> You have already taken the quiz today!</h3>
      ) : null}
      <p class="quizIntro">
        {" "}
        Take a quiz and earn cash for correct answers! Your current cash at this
        time is ${cash.toFixed(2)}
      </p>
      {complete ? (
        <section>
          {" "}
          <div className="score">
            {" "}
            <h3>Thank you for completing today's quiz!</h3>
        ...
        <div className="quiz">
          ...
          <div className="answers">
            {questions[currentQuestion].answers.map((answerOption) => (
              <h3 className="answer" onClick={() => handleAnswer(answerOption)}>
