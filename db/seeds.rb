...
Stock3 = Stock.create(name:"ABCs", img:"https://i.pinimg.com/originals/ba/d8/d9/bad8d950df4cce2304381b68e38a5f0a.png", cap:"Largecap", industry:"tech", price:2960.00, market_cap: 1830000000000000  )
...
Stock9 = Stock.create(name:"Woobly Tech Support", img:"https://i.imgur.com/LUnccdL.jpg", cap:"Smallcap", industry:'tech', price:10.00)
...
User1 = User.create(id: 1, username:"test", password:"test", cash: 10000.00)
