...
This project is intended to be a tool to teach younger audiences about financial systems in our world. The app allows users to buy and sell paraody stocks as the numbers are randomly altered based on their cap size. Users can see how long they keep selling stock with a fixed cause for a given period or play in "freestyle" mode where there the turns simply change the prices. The app also includes a daily quiz allowing users to test their knowledge of finanical news and basic financial concepts.
